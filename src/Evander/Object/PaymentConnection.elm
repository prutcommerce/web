...
module Evander.Object.PaymentConnection exposing (..)
...
edges :
    ...
    -> SelectionSet (List decodesTo) Evander.Object.PaymentConnection
edges object____ =
    Object.selectionForCompositeField "edges" [] object____ (Basics.identity >> Decode.list)


pageInfo :
    SelectionSet decodesTo Evander.Object.PageInfo
